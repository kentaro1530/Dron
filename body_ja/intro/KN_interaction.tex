...
As mentionted as before section, the $\Lambda(1405)$ has been predicted as a quasi-bound state of the $\bar{K}N$ state and has been discussed as such.
In order words, it is necessaray the information of the $\bar{K}N$ interaction in order to understand the structure of the $\Lambda(1405)$.
...
This result was verified and updated by the DA$\phi$NE collaboration in 2005 and the SIDDAHARTA collaboration in 2011 \cite{SIDDAHARTA}.
...
Some theoretical groups consistently reproduced  the KN scattering amplitude on this constraint and scattering data above the $\bar{K}N$ threshold
using various approch based on low energy scattering therm \cite{Ikeda1,Ikeda2,Mai,Guo,Mai2,Cieply}.
Although, there are large uncertainty due to shortage of the data in low energy region.
