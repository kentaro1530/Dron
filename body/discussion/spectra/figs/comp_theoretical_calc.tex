\begin{figure}[htbp]
  ...
  \caption{
    ...
    The right figure shows the spectrum predicted by the DCC model \cite{DCC2}, and the left figure shows the spectrum predicted by the calculation of Miyagawa et al \cite{Miyagawa}.
