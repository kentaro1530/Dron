\begin{frame}{Fitting of invariant masses}
  ...
  \begin{tabular}{ccc}
    \begin{minipage}{0.33\hsize}
      \begin{figure}
        \includegraphics[width=4cm]{../pic/Run78/KN_ana/IM_pipi.eps}
      \end{figure}
    \end{minipage}
    
    \begin{minipage}{0.33\hsize}
      \begin{figure}
        \includegraphics[width=4cm]{../pic/Run78/KN_ana/IM_npim.eps}
      \end{figure}
    \end{minipage}
    
    \begin{minipage}{0.33\hsize}
      \begin{figure}
        \includegraphics[width=4cm]{../pic/Run78/KN_ana/IM_npip.eps}
      \end{figure}
    \end{minipage}
  \end{tabular}
