  ...
  \begin{tabular}{cc}
    ...
    \begin{minipage}{0.75\hsize}
      \begin{eqnarray*}
        ...
        G_0(q_1, q_2) & = & \frac{1}{q_0^q - {\bf q}^2 + i \epsilon} \\
        & & \mbox{: Green Function of the $\bar{K}$} \\
        T_{K^- p \rightarrow \bar{K}N} & : & \mbox{ Data from Gopal et. el. \cite{Gopal}} \\
        \Phi(q_{N2}) & : & \mbox{Wave-function of deuteron \cite{d_fermi_theo}}
      \end{eqnarray*}      
    \end{minipage}
  \end{tabular}
